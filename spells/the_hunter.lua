...
local menu_elements = {
    ...
    the_hunter_mode              = combo_box:new(0, get_hash(my_utility.plugin_label .. "the_hunter_cast_modes_base")),
    min_hits_slider             = slider_int:new(0, 30, 5, get_hash(my_utility.plugin_label .. "the_hunter_min_hits_slider_base")),

    allow_elite_single_target   = checkbox:new(true, get_hash(my_utility.plugin_label .. "allow_elite_single_target_base")),
    effect_size_affix_mult      = slider_float:new(0.0, 200.0, 0.0, get_hash(my_utility.plugin_label .. "the_hunter_effect_size_affix_mult_slider_base")),
}
...
local function menu()
    if menu_elements.the_hunter_submenu:push("The Hunter") then
        ...
        if menu_elements.the_hunter_boolean:get() then
            ...
            menu_elements.the_hunter_mode:render("Cast Modes", dropbox_options, "")
...
local function logics()
    ...
    local spell_effect_radius_raw = 3.90 -- radius of the_hunter
